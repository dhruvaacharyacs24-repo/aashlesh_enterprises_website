    ...
    <header className="sticky top-0 z-40 border-b border-border/60 bg-background/85 backdrop-blur supports-[backdrop-filter]:bg-background/70">
      <div className="container-page flex h-16 items-center justify-between gap-4">
        <Link to="/" className="flex items-center gap-3 group" onClick={() => setOpen(false)}>
          <div className="rounded-md bg-transparent px-2 py-1.5">
            <div className="flex flex-col leading-none">
              <span className="text-[1rem] font-semibold tracking-[0.2em] text-ink">AASHLESHA</span>
              <span className="mt-1 text-[0.7rem] font-medium uppercase tracking-[0.35em] text-primary">ENTERPRISES</span>
            </div>
          </div>
        </Link>
